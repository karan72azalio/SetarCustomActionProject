...
@JsonTypeInfo(
        ...
        defaultImpl = com.nokia.nsw.uiv.model.resource.OperatingSystem.class,
        include = JsonTypeInfo.As.EXISTING_PROPERTY,
        visible = true,
        property = "@type"
)
@JsonFilter("com.nokia.nsw.uiv.model.resource.OperatingSystem")
public class OperatingSystem extends UivDatatypeObject {
    @JsonView({
