...
public class LogicalInterfaceCustomRepositoryImpl implements LogicalInterfaceCustomRepository {
    ...
    @Override
    public <S extends LogicalInterface> S batchSave(S s, int i, String s1) {
        return null;
    }

    @Override
    public <S extends LogicalInterface> Iterable<S> batchSaveAll(Iterable<S> iterable, int i, String s) {
        return null;
    }
    ...
    @Override
    public <S extends LogicalInterface> Optional<S> findOne(Example<S> example) {
        return Optional.empty();
    }

    @Override
    public <S extends LogicalInterface> Iterable<S> findAll(Example<S> example) {
        return null;
    }

    @Override
    public <S extends LogicalInterface> Iterable<S> findAll(Example<S> example, Sort sort) {
        return null;
    }

    @Override
    public <S extends LogicalInterface> Page<S> findAll(Example<S> example, Pageable pageable) {
        return null;
    }

    @Override
    public <S extends LogicalInterface> long count(Example<S> example) {
        return 0;
    }

    @Override
    public <S extends LogicalInterface> boolean exists(Example<S> example) {
        return false;
    }

    @Override
    public <S extends LogicalInterface, R> R findBy(Example<S> example, Function<FluentQuery.FetchableFluentQuery<S>, R> queryFunction) {
        return null;
    }
}
