    ...
    public Object doPost(ActionContext actionContext) throws Exception {
        ...
        try {
            ...
            if (optCustomer.isPresent()) {
                ...
                if (request.getSubsAddress() != null) custProps.put("subsAddress", request.getSubsAddress());
                if (request.getCompanyName() != null) custProps.put("companyName", request.getCompanyName());
                if (request.getContactPhone() != null) custProps.put("contactPhone", request.getContactPhone());
